...
?>
<a href="<?php echo "?p=jasakirim"; ?>"><button type="button" class='btn btn-add'>JASA PENGIRIMAN</button></a> &raquo; 
...
<div class="isicard" style="text-align:center;">
  <form name="form1" method="post" action="" enctype="multipart/form-data">	
    ...
    <input name="nama" type="text" id="nama" value="<?php echo "$rj[nama]"; ?>"  placeholder="Nama Jasa Pengiriman">
    <textarea name="detail" id="detail" placeholder="Detail Jasa Pengiriman"><?php echo "$rj[detail]"; ?></textarea>
    <input name="tarif" type="text" id="harga" value="<?php echo "$rj[tarif]"; ?>" placeholder="Tarif Jasa Pengiriman (dalam IDR/Kg)">
